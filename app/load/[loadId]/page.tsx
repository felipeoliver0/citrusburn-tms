  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 p-8 font-sans">
      ...
      {(load.inspections.length > 0) && (
        <div className="max-w-5xl mx-auto mt-6 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {pickup?.vinPhoto && (
                      <div className="border border-gray-200 rounded-lg overflow-hidden group relative">
                        <img src={pickup.vinPhoto} alt="Pickup VIN" className="w-full h-32 object-cover group-hover:scale-105 transition-transform" />
                    ...
                    {pickup?.photos && pickup.photos.map((photo: any, idx: number) => (
                      <div key={idx} className="border border-gray-200 rounded-lg overflow-hidden group relative">
                        <img src={photo.photoUrl} alt={photo.description || 'Photo'} className="w-full h-32 object-cover group-hover:scale-105 transition-transform" />
              ...
              return (
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {delivery?.vinPhoto && (
                      <div className="border border-gray-200 rounded-lg overflow-hidden group relative">
                        <img src={delivery.vinPhoto} alt="Delivery VIN" className="w-full h-32 object-cover group-hover:scale-105 transition-transform" />
                        <div className="absolute bottom-0 inset-x-0 bg-black/60 text-white text-[10px] font-bold uppercase tracking-wider p-1 text-center backdrop-blur-sm">VIN Photo</div>
                      </div>
                    )}
