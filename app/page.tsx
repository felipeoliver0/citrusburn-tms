...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen relative overflow-hidden bg-gray-50 text-gray-900 font-sans selection:bg-brand-500 selection:text-white">
      ...
      <div className="absolute top-[-15%] left-[-10%] w-[60%] h-[60%] bg-blue-100/40 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-blue-50/50 rounded-full blur-[120px] pointer-events-none animate-float" />
      <div className="absolute top-[20%] right-[10%] w-[30%] h-[30%] bg-slate-200/30 rounded-full blur-[100px] pointer-events-none" />
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 py-6 max-w-7xl w-full mx-auto animate-fade-in glass-panel rounded-b-3xl mb-8">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link href="/register" className="text-sm font-bold bg-gray-900 text-white px-5 py-2.5 rounded-full hover:bg-blue-600 hover:shadow-lg hover:shadow-blue-600/20 hover:-translate-y-0.5 transition-all">
            Get Started
          </Link>
        </div>
      </nav>
      ...
      <main className="relative z-10 flex flex-col items-center justify-center flex-1 text-center px-4 pt-12 pb-24">
        ...
        <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          <Link href="/register" className="group flex items-center justify-center gap-2 bg-blue-600 text-white px-8 py-4 rounded-full font-bold text-lg shadow-xl shadow-blue-600/30 hover:shadow-2xl hover:shadow-blue-600/40 hover:-translate-y-1 hover:bg-blue-700 transition-all">
            Start for Free
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </Link>
          <Link href="#pricing" className="flex items-center justify-center gap-2 bg-white/80 backdrop-blur-sm text-gray-800 border border-gray-200 px-8 py-4 rounded-full font-bold text-lg hover:bg-white hover:border-blue-300 hover:shadow-md transition-all">
            View Pricing
          </Link>
        </div>
      </main>
      ...
      <section className="bg-gray-900 text-white py-24 relative z-10 overflow-hidden rounded-3xl mx-4 lg:mx-8 mb-24 shadow-2xl">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-5xl bg-blue-500/10 blur-[120px] pointer-events-none" />
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-300 text-sm font-bold mb-6">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="bg-white/80 backdrop-blur-xl border border-gray-200 rounded-[2.5rem] p-10 shadow-lg hover:shadow-xl transition-shadow flex flex-col h-full">
            ...
            <ul className="space-y-5 mb-10 flex-1">
              <li className="flex items-center gap-4 font-bold text-gray-700"><CheckCircle2 className="w-6 h-6 text-blue-600" /> Unlimited Load Posts</li>
              <li className="flex items-center gap-4 font-bold text-gray-700"><CheckCircle2 className="w-6 h-6 text-blue-600" /> Carrier Verification</li>
              <li className="flex items-center gap-4 font-bold text-gray-700"><CheckCircle2 className="w-6 h-6 text-blue-600" /> Volume Analytics Dashboard</li>
            </ul>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-[2.5rem] p-10 shadow-2xl relative flex flex-col transform md:scale-105 z-10 overflow-hidden group">
            ...
            <div className="absolute top-0 right-8 bg-blue-600 text-white text-xs font-black uppercase tracking-widest py-2 px-4 rounded-b-xl shadow-lg">Popular</div>
            <div className="mb-8 relative z-10">
              ...
              <div className="inline-flex items-center gap-1.5 bg-blue-500/20 border border-blue-500/30 text-blue-300 text-xs font-bold px-3 py-1.5 rounded-lg mb-4">
            ...
            <ul className="space-y-5 mb-10 flex-1 relative z-10">
              <li className="flex items-center gap-4 font-bold text-gray-200"><CheckCircle2 className="w-6 h-6 text-blue-400" /> Full Loadboard Access</li>
              <li className="flex items-center gap-4 font-bold text-gray-200"><CheckCircle2 className="w-6 h-6 text-blue-400" /> Unlimited Dispatching</li>
              <li className="flex items-center gap-4 font-bold text-gray-200"><CheckCircle2 className="w-6 h-6 text-blue-400" /> Revenue Analytics</li>
              <li className="flex items-center gap-4 font-bold text-gray-200"><CheckCircle2 className="w-6 h-6 text-blue-400" /> Mobile Driver App Access</li>
            </ul>
            <Link href="/register" className="relative z-10 w-full text-center bg-blue-600 text-white font-black py-4 rounded-2xl hover:bg-blue-500 hover:shadow-lg hover:shadow-blue-500/30 transition-all hover:-translate-y-0.5">
              Start Free Trial
            </Link>
          </div>
        </div>
      ...
      <footer className="relative z-10 border-t border-gray-200 bg-white/50 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex gap-6 text-sm font-bold text-gray-500">
            ...
            <Link href="/terms" className="hover:text-blue-600 transition-colors" target="_blank">Terms of Service</Link>
